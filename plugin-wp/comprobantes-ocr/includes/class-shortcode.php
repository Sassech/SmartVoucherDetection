    ...
    public function render(): string {
        ...
        <div class="cocr-upload-wrap" data-nonce="<?php echo esc_attr( $nonce ); ?>">
            ...
            <div class="cocr-dropzone" id="cocr-dropzone">
                <label for="cocr-file-input" class="cocr-file-label" style="display:none"><?php esc_html_e( 'Seleccionar archivo de comprobante', 'comprobantes-ocr' ); ?></label>
                <input
                    type="file"
                    id="cocr-file-input"
                    ...
                    multiple
                    style="display:none"
                    aria-label="<?php esc_attr_e( 'Seleccionar archivo de comprobante', 'comprobantes-ocr' ); ?>"
                />
                <p>
